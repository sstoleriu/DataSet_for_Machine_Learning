...
public class Semafor implements Obiect, Draw{
	 ...
	 *  *  - Initializeaza imaginea adaugata si culoarea specifica pentru chenar(gri)
	...
	/**
	 * Metoda pentru desenarea dreptunghiului - Preluare coordonate puncte si desenare dreptunghi
	 */
	public void draw() {
