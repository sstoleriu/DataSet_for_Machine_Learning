...
public class Pieton implements Obiect, Draw{
	...
	/**
	 * Constructor de initializare cu parametri pentru clasa Pieton
	 *  *  - Initializeaza imaginea adaugata si culoarea specifica pentru chenar(magenta)
	 * @param Add_image Obiect de tipul clasei Add_Image
	 */
    public Pieton(Add_Image Add_image){
