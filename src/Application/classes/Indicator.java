...
public class Indicator implements Obiect, Draw{
	...
	/**
	 * Constructor de initializare cu parametri pentru clasa Indicator
	 *  *  - Initializeaza imaginea adaugata si culoarea specifica pentru chenar(portocaliu)
	 * @param Add_image Obiect de tipul clasei Add_Image
	 */
    public Indicator(Add_Image Add_image){
    	this.Add_image = Add_image;
    	this.culoare=Color.ORANGE;
    }
